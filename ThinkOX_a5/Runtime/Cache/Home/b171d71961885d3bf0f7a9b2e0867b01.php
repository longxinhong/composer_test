    ...
    <div class="col-xs-9 login">
        <div class="col-md-6 col-xs-12 lg_left">
            <div class="col-xs-12">
                ...
                <form action="/thinkox_a5/index.php?s=/home/user/login.html" method="post" class="lg_lf_form " >
        ...
        <div class="col-md-6 col-xs-12">
            ...
            <div class="hidden-xs hidden-sm" style="margin: 21px 0 16px 40px;">
                <img class="img-responsive" src="/thinkox_a5/Public/Home/images/login_img.png" alt="">
            </div>
