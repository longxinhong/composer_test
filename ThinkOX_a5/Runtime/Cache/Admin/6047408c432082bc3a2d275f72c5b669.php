...
<head>
    ...
    <link rel="stylesheet" href="/thinkox_a5/Public/Admin/js/codemirror/codemirror.css">
    <link rel="stylesheet" href="/thinkox_a5/Public/Admin/js/codemirror/theme/<?php echo C('codemirror_theme');?>.css">
    <style>
        ...
        #preview_window.loading {
            background: url('/thinkox_a5/Public/static/thinkbox/skin/default/tips_loading.gif') no-repeat center;
        }
...
<script type="text/javascript">
    ...
    <script type="text/javascript" src="/thinkox_a5/Public/Admin/js/codemirror/codemirror.js"></script>
    <script type="text/javascript" src="/thinkox_a5/Public/Admin/js/codemirror/clike.js"></script>
    <script type="text/javascript" src="/thinkox_a5/Public/Admin/js/codemirror/sql.js"></script>
    <script type="text/javascript" src="/thinkox_a5/Public/static/thinkbox/jquery.thinkbox.js"></script>
    <script type="text/javascript">
