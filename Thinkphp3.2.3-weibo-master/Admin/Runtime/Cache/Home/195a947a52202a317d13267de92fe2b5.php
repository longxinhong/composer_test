	...
	<table class='table'>
		...
		<?php if(is_array($users)): foreach($users as $key=>$v): ?><tr>
				...
				<td width='80' align='center'>
					<img src="<?php if($v["face"]): ?>/Thinkphp3.2.3-weibo-master/Uploads/Face/<?php echo ($v["face"]); else: ?>/Thinkphp3.2.3-weibo-master/Public/Images/noface.gif<?php endif; ?>" width='50' height='50'/>
				</td>
				<td align='center'>
					<ul>
